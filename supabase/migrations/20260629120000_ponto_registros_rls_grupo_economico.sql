-- Gestores do grupo Fênix podem ver/ajustar ponto de qualquer unidade do mesmo grupo
-- (antes: só empresa_id = users.empresa_id do login → espelho vazio ao filtrar Catalão).
