-- Criação de usuários sem passar pelo endpoint público /auth/v1/signup
-- para uso interno do painel administrativo.
...
BEGIN
  ...
  -- Admin da empresa só pode criar usuário para a própria empresa.
