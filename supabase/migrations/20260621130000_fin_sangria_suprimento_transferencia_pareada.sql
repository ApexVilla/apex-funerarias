-- Sangria/suprimento: saída na origem + entrada no destino (fin_movimentacoes pareadas) e caixa físico correto.
...
BEGIN
    ...
    -- 4) Se o destino tiver caixa aberto: registrar ENTRADA (não suprimento)
